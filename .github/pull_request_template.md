...
- [ ] Exercised against a real Last.fm account, for a monitoring, authentication or data-handling change

<!-- A monitoring or authentication change is not verified by the offline suite alone, which never
     contacts Last.fm. Say what you ran it against, without usernames or credentials. -->
...
<!-- Never include Last.fm API keys and secrets, Spotify credentials, SMTP passwords, webhook URLs or ntfy tokens or the accounts you monitor in a pull request. -->
