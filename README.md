...
If you use lastfm_monitor in research or writing, cite it with the metadata in [CITATION.cff](https://github.com/misiektoja/lastfm_monitor/blob/main/CITATION.cff). GitHub renders it as **Cite this repository** on the repository page and exports it as BibTeX or APA.
